          ...
          <div className="af-class-body">
            ...
            <div id="courses" className="af-class-section-courses">
              ...
              <div className="af-class-container-7 w-container">
                {map(proxies['course-home'], props => <div {...{...props, className: `af-class-dropdown-wrapper ${props.className || ''}`}}>{createScope(props.children, proxies => <React.Fragment>
                  <CourseHomeView.Controller />
                  <div className="af-class-dropdown af-class-hidden">
                    <div data-w-id="fa70b82d-84c3-d193-a03e-ced5befaa3b4" className="af-class-dropdown-trigger">
                    ...
                    <div style={{height: '0PX', display: 'block'}} className="af-class-dropdown-content">
                      <div className="af-class-cladd-desc-wrapper">
                        <div className="w-layout-grid af-class-grid_course_home">
                          <div id="w-node-ced5befaa3bc-fbba94a3" className="af-class-course-card">
                          ...
                          <div id="w-node-ced5befaa3ca-fbba94a3" className="af-class-course-card">
                          ...
                          <div id="w-node-ced5befaa3df-fbba94a3" className="af-class-course-card">
                          ...
                          <div id="w-node-ced5befaa3ed-fbba94a3" className="af-class-course-card af-class-dates">
                          ...
                          </div>{map(proxies['register'], props => <a id="w-node-ced5befaa402-fbba94a3" href="#" {...{...props, className: `af-class-cors-register-now-2 af-class-courses ${props.className || ''}`}}>{props.children ? props.children : <React.Fragment>Register now</React.Fragment>}</a>)}</div>
                      </div>
                    </div>
                  </div>
                </React.Fragment>)}</div>)}
