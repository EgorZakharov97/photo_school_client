    ...
    return (
      <span>
        ...
        <span className="af-view">
          <form id="wf-form-courseForm" name="wf-form-courseForm" data-name="courseForm" method="post" encType="multipart/form-data" className="af-class-form-5"><label htmlFor="name-12">Challenge name</label>{map(proxies['name'], props => <input type="text" maxLength={256} name="name" data-name="name" placeholder="Challenge Name" id="name-12" required {...{...props, className: `w-input ${props.className || ''}`}}>{props.children}</input>)}<label>Challenge preview image</label>
...
/* eslint-enable */eadline-3">Registration Deadline</label>
