                    ...
                    <div className="af-class-login-form">
                      <div className="w-form">
                        <form id="wf-form-Register" name="wf-form-Register" data-name="Register" action="/auth/update" method="post">
                          <div className="af-class-text-block-10">email@gmail.com</div><input type="text" className="af-class-login-input w-input" autofocus="true" maxLength={256} name="username" data-name="Username" placeholder="Name" id="username" required /><input type="password" className="af-class-login-input w-input" maxLength={256} name="password" data-name="Password" placeholder="Password" id="password" required /><input type="password" className="af-class-login-input w-input" maxLength={256} name="password_2" data-name="password_2" placeholder="Repeat Password" id="password_-4" required /><input type="tel" className="af-class-login-input w-input" maxLength={256} name="phoneNumber" data-name="Phone Number" placeholder="Phone Number" id="phoneNumber" required /><input type="email" className="af-class-login-input af-class-invisible w-input" maxLength={256} name="email" data-name="email" placeholder="email" id="email" required /><select id="Level" name="Level" required data-name="Level" className="af-class-login-input w-select"><option value="beginner">Beginner</option><option value="advanced">Advanced</option><option value="intermediate">Intermediate</option><option value="professional">Professional</option></select><select id="sex" name="sex" required data-name="Sex" className="af-class-login-input w-select"><option value="Prefer not to say">Sex</option><option value="Male">Male</option><option value="Female">Female</option><option value="Hybrid">Hybrid</option></select><input type="submit" defaultValue="Update" data-wait="Please wait..." className="af-class-login-submit w-button" /></form>
