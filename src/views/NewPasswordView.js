                ...
                <div className="af-class-window-body">
                  ...
                  <div className="af-class-login-form">
                    <div className="w-form">
                      <form id="reset" name="wf-form-new-password" data-name="new-password" action="/auth/local/reset/###" method="post">{map(proxies['password'], props => <input type="password" maxLength={256} name="password" data-name="password" placeholder="New Password" id="password-8" required {...{...props, className: `af-class-login-input w-input ${props.className || ''}`}}>{props.children}</input>)}{map(proxies['password_2'], props => <input type="password" maxLength={256} name="password_2" data-name="password_2" placeholder="Repeat New Password" id="password_-5" required {...{...props, className: `af-class-login-input w-input ${props.className || ''}`}}>{props.children}</input>)}{map(proxies['submit'], props => <input type="submit" value="Re-new Password" data-wait="Please wait..." {...{...props, className: `af-class-login-submit w-button ${props.className || ''}`}}>{props.children}</input>)}
