              ...
              <div className="w-commerce-commercelayoutcontainer w-container">
                <div className="w-commerce-commercelayoutmain">
                  ...
                  <form data-node-type="commerce-checkout-shipping-address-wrapper" className="w-commerce-commercecheckoutshippingaddresswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutshippingfullname" /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutshippingstreetaddress" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutshippingstreetaddressoptional" />
                      <div className="w-commerce-commercecheckoutrow">
                        ...
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" name="address_zip" required className="w-commerce-commercecheckoutshippingzippostalcode" /></div>
                  ...
                  <form data-node-type="commerce-checkout-shipping-methods-wrapper" className="w-commerce-commercecheckoutshippingmethodswrapper">
                    ...
                    <fieldset>
                      <div data-node-type="commerce-checkout-shipping-methods-list" className="w-commerce-commercecheckoutshippingmethodslist" data-wf-collection="database.commerceOrder.availableShippingMethods" data-wf-template-id="wf-template-5f228d014c59484d580487cc000000000042"><label className="w-commerce-commercecheckoutshippingmethoditem"><input type="radio" required name="shipping-method-choice" /><div className="w-commerce-commercecheckoutshippingmethoddescriptionblock"><div className="w-commerce-commerceboldtextblock" /><div /></div><div /></label></div>
                  ...
                  <form data-node-type="commerce-checkout-billing-address-wrapper" style={{display: 'none'}} className="w-commerce-commercecheckoutbillingaddresswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Full Name *</label><input type="text" name="name" required className="w-commerce-commercecheckoutbillingfullname" /><label className="w-commerce-commercecheckoutlabel">Street Address *</label><input type="text" name="address_line1" required className="w-commerce-commercecheckoutbillingstreetaddress" /><input type="text" name="address_line2" className="w-commerce-commercecheckoutbillingstreetaddressoptional" />
                      <div className="w-commerce-commercecheckoutrow">
                        ...
                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" name="address_zip" required className="w-commerce-commercecheckoutbillingzippostalcode" /></div>
                  ...
                  <div className="w-commerce-commercecheckoutorderitemswrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent">
                      <div className="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-5f228d014c59484d580487cc000000000086" />
                    </fieldset>
                  </div>
                </div>
                <div className="w-commerce-commercelayoutsidebar">
                  <div className="w-commerce-commercecheckoutordersummarywrapper">
                    ...
                    <fieldset className="w-commerce-commercecheckoutblockcontent">
                      ...
                      <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-5f228d014c59484d580487cc0000000000a0">
