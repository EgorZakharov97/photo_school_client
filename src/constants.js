...
export const URL_GET_ALL_USERS = '/api/v1/admin/users';
export const URL_GET_ALL_SUBSCRIBERS = '/api/v1/admin/subscribers';

export const URL_GET_TEMPLATE_NAMES = '/api/v1/admin/template';
export const URL_POST_TEMPLATE = '/api/v1/admin/template';
...
export const URL_ANOTHER_CONFIRMATION = '/api/v1/auth/send-confirmation';
